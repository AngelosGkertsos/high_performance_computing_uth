...
double sobel(unsigned char *restrict input, unsigned char *restrict output, unsigned char *restrict golden, int silent_mode)
{
    ...
    register int gradient_x, gradient_y, col_right, temp_i, old_right_column_sum_1, old_right_column_sum_2;
    ...
    register unsigned char *row_0;
    register unsigned char *row_1;
    register unsigned char *row_2;
    unsigned int cur_row;
    register int r0_c1, r1_c1, r2_c1, r0_c2, r1_c2, r2_c2;
